...
ActiveRecord::Schema.define(version: 2022_05_30_153452) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "name"
    t.string "role"
    t.integer "employement_status"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
  end

  create_table "usrprojects", force: :cascade do |t|
    t.date "time"
    t.integer "user_id", null: false
    t.integer "project_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["project_id"], name: "index_usrprojects_on_project_id"
    t.index ["user_id"], name: "index_usrprojects_on_user_id"
  end
